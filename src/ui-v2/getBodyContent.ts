  ...
  return `
	<div class="header">
		<div style="display: flex; align-items: center;">
			...
			<span id="versionDisplay" style="font-size: 12px; color: var(--vscode-descriptionForeground); margin-left: 8px; opacity: 0.7; align-self: flex-end; margin-bottom: 2px;">v1.5.3</span>
	...
	<div id="statsPanel" class="stats-panel" style="display: none;">
		<div class="stats-header">
			<h3>Usage Statistics <span style="font-size: 12px; color: var(--vscode-descriptionForeground); font-weight: normal;">(Price calculated based on Opus-4 model)</span></h3>
