  ...
  return `
	<div class="header">
		<div style="display: flex; align-items: center;">
			...
			<span id="versionDisplay" style="font-size: 12px; color: var(--vscode-descriptionForeground); margin-left: 8px; opacity: 0.7; align-self: flex-end; margin-bottom: 2px;">v3.0.9</span>
