...
## 建议先不要使用1.0.51版本，提示词遵循不太好，MCP调用差。建议先用1.0.48版本-2025.07.13
>
> ⚡ **Claude Code v1.0.51+ 用户注意**：
>
> * 请确保系统PATH中没有`Git\bin`路径，否则会遇到启动错误
> * 修改系统环境变量后必须**重启电脑**才能生效
> * 详见[环境准备](#-第-1-步环境准备仅需一次)部分
